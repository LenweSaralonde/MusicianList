...
--- Chat commands
msg.COMMAND_SAVE = "Speichern Sie das aktuelle Lied in der Liste"
msg.COMMAND_SAVE_PARAMS = "[** <Liedname> **]"
msg.COMMAND_LOAD = "Laden Sie ein Lied aus der Liste"
msg.COMMAND_LOAD_PARAMS = "{** <Liedname> ** || ** <song #> **}"
msg.COMMAND_PLAY = "Laden und spielen Sie ein Lied aus der Liste oder spielen / stoppen Sie das aktuelle Lied"
msg.COMMAND_PLAY_OLD = "Laden Sie ein Lied aus der Liste und spielen Sie es ab oder spielen Sie das aktuelle Lied ab"
...
msg.COMMAND_PREVIEW_OLD = "Laden Sie ein Lied aus der Liste und zeigen Sie eine Vorschau an, oder zeigen Sie eine Vorschau des aktuellen Liedes an"
msg.COMMAND_PREVIEW_PARAMS = "[{** <Liedname> ** || ** <song #> **}]"
msg.COMMAND_LIST = "Songliste anzeigen"
msg.COMMAND_DELETE = "Löschen Sie ein Lied aus der Liste oder löschen Sie das aktuelle Lied"
msg.COMMAND_DELETE_PARAMS = "[{** <Liedname> ** || ** <song #> **}]"
msg.COMMAND_RENAME = "Benennen Sie ein Lied in der Liste um oder benennen Sie das aktuelle Lied um"
msg.COMMAND_RENAME_PARAMS = "[** <song #> ** [** <neuer Name> **]]"
msg.COMMAND_FIND = "Finde ein Lied in der Liste"
msg.COMMAND_FIND_PARAMS = "** <Liedname> **"
msg.COMMAND_RESTORE_DEMO = "Stellen Sie Demo-Songs wieder her"
...
msg.ACTION_SAVE = "Speichern Sie in der Liste"
...
msg.DELETE_CONFIRM = "Sind Sie sicher, dass Sie \"% s\" löschen möchten?"
...
--- Error messages
msg.ERR_OUTDATED_MUSICIAN_VERSION = "Ihre Version von Musician ist veraltet und kann nicht mit MusicianList verwendet werden. Bitte aktualisieren Sie das Musician Addon."
msg.ERR_OUTDATED_MUSICIANLIST_VERSION = "Ihre Version von MusicianList ist veraltet und kann nicht mehr verwendet werden. Bitte aktualisieren."
